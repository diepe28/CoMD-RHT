...
mpirun -np 1  ../bin/CoMD-mpi -e -i 1 -j 1 -k 1 -x 70 -y 70 -z 70
mpirun -np 2  ../bin/CoMD-mpi -e -i 2 -j 1 -k 1 -x 70 -y 70 -z 70
mpirun -np 4  ../bin/CoMD-mpi -e -i 2 -j 2 -k 1 -x 70 -y 70 -z 70
